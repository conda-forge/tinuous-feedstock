...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tinuous-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13027&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tinuous-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tinuous` can be installed with:

```
conda install tinuous
```

It is possible to list all of the versions of `tinuous` available on your platform with:
